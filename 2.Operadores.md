...
```sql
     ...
     returns intervalo
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','sumaIntervalo'
...
```sql
     ...
     returns intervalo
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','restaIntervalo'
     language c immutable strict;
```
...
```sql
     ...
     returns intervalo
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','productoIntervalo'
     language c immutable strict;
```
...
```sql
     ...
     returns intervalo
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','cocienteIntervalo'
     language c immutable strict;
```
...
```sql
     ...
     returns intervalo
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','inversoIntervalo'
     language c immutable strict;
```
...
```sql
     ...
     returns boolean
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','menorQue'
     language c immutable strict;
```
...
```sql
     ...
     returns boolean
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','mayorQue'
     language c immutable strict;
```
...
```sql
     ...
     returns boolean
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','menorIgualQue'
     language c immutable strict;
```
...
```sql
     ...
     returns boolean
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','mayorIgualQue'
     language c immutable strict;
```
...
```sql
     ...
     returns boolean
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','igualdadIntervalos'
     language c immutable strict;
```
...
```sql
     ...
     returns boolean
     as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','distintosIntervalos'
     language c immutable strict;
``` 
