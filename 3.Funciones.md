...
```sql
	...
	returns float8[]
	as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','Intervalo_init'
	language c immutable strict;

	create or replace function estado_final(float8[])
	returns intervalo
	as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','Intervalo_final'
	language c immutable strict;
...
```sql
	...
	returns float8[]
	as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','media_inicial'
	language c immutable strict;

	create or replace function media_final(float8[])
	returns float8
	as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','media_final'
	language c immutable strict;
...
```sql
	...
	returns float8[]
	as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','varianza_inicial'
	language c immutable strict;

	create or replace function varianza_final(float8[])
	returns float8
	as '/opt/PostgreSQL/9.4/lib/intervalo.so.14','varianza_final'
	language c immutable strict;
